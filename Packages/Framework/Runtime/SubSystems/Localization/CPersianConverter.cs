/*
 * Description: I DO NOT KNOW HOW IT WORKS! ALMOST!
 * Author: SOMEONE
 * Importer: Mohammad Hasan Bigdeli
 * Import Time: 1 / 27 / 2018
 */
...
namespace Revy.Framework.Localization.Convertor
{
    public static class CPersianConverter
    {
