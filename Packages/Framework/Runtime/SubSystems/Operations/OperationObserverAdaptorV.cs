...
{
	public class OperationObserverAdaptorV<TValue> : IOperation
	{
		public OperationObserverAdaptorV(IOperationObserverV<TValue> operation)
		{
		...
		private IOperationObserverV<TValue> _operation;
	}
}
