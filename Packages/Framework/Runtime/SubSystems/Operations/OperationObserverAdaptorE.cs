...
{
	public class OperationObserverAdaptorE<TError> : IOperation
	{
		public OperationObserverAdaptorE(IOperationObserverE<TError> operation)
		{
		...
		private IOperationObserverE<TError> _operation;
	}
}
