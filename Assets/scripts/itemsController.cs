...
public class itemsController : MonoBehaviour
{
    ...
    public void dropItems(int numItemDrop,int itemObj)
    {
        for (int i = 0; i < numItemDrop; i++)
        {
            GameObject sc = controller.Instance.generateGameObj(itemsGo[itemObj], parentItems);
            ...
            sc.GetComponent<itemObj>().index = itemObj;
        }
    }
