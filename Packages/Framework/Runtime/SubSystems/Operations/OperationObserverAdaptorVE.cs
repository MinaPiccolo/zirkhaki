...
{
	public class OperationObserverAdaptorVE<TValue, TError> : IOperation
	{
		public OperationObserverAdaptorVE(IOperationObserverVE<TValue, TError> operation)
		{
		...
		private IOperationObserverVE<TValue, TError> _operation;
	}
}
